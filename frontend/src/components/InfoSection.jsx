...
<Typography variant="h5" marginY={2} sx={{
            ...
            <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                ...
                <AccordionDetails>
                    ...
                    <img className='info-img' src="https://armenpress.am/static/news/b/2023/05/1111849.jpg" alt="" srcset="" />
                </AccordionDetails>
            </Accordion>
            <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
                ...
                <AccordionDetails>
                    ...
                    <img className='info-img' src="https://images.unsplash.com/photo-1481627834876-b7833e8f5570?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1228&q=80" alt="" srcset="" />
                </AccordionDetails>
            </Accordion>
            <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
                ...
                <AccordionDetails>
                    ...
                    <img className='info-img' src="https://images.unsplash.com/photo-1545262841-5283004cef19?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=764&q=80" alt="" srcset="" />
                </AccordionDetails>
            </Accordion>
            <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
                ...
                <AccordionDetails>
                    ...
                    <img className='info-img' src="https://images.unsplash.com/photo-1513737567531-bc431c8e5e85?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=688&q=80" alt="" srcset="" />
                </AccordionDetails>
            </Accordion>
            <Accordion expanded={expanded === 'panel5'} onChange={handleChange('panel5')}>
                ...
                <AccordionDetails>
                    ...
                    <img className='info-img' src="https://images.unsplash.com/photo-1517960413843-0aee8e2b3285?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1199&q=80" alt="" srcset="" />
                </AccordionDetails>
            </Accordion>
            <br />
            <br />
